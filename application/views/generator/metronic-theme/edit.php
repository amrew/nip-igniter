...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li>
    <?php echo $model->{content:primary}?'Edit Record':'New Record';?>
  </li>
</ul>
    ...
    <div class="portlet light">
      <div class="portlet-title">
        <div class="caption">
          ...
          <?php echo $model->{content:primary}?'<i class="fa fa-edit"></i> Edit Record':'<i class="fa fa-plus-circle"></i> New Record';?>
          </span>
        </div>
        <div class="tools">
