 ...
 */
class {content:class}Controller extends Nip_Controller 
{
     ...
     * 
     * @param integer 	${content:primary} primary key for the current model
     *
     * @return void
     *
     * @access public
     */
	public function edit(${content:primary} = NULL) {
     ...
     * @access public
     */
	public function view(${content:primary}) {
		$model = $this->Model->first(array("{content:primary}"=>${content:primary}));
