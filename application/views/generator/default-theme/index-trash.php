				...
				<?php foreach($rows as $i => $row):?>
					<tr id="tr-<?php echo $row->{content:primary};?>">
						...
						<td class="hidden-print">
							<button class="btn btn-success btn-xs btn-action" data-id="<?php echo $row->{content:primary};?>" data-url="<?php echo site_url("{$this->controller}/restore/trash");?>">Restore</button>
							<button class="btn btn-danger btn-xs btn-action" data-id="<?php echo $row->{content:primary};?>" data-url="<?php echo site_url("{$this->controller}/force-delete");?>">Delete</button>
						</td>
					</tr>
