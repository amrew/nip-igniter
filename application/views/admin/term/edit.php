...
<!-- BEGIN PAGE CONTENT-->
<div class="row">
  <div class="col-md-<?php echo (!$this->input->is_ajax_request())?7:12;?>">
    <div class="portlet light">
      ...
      <div class="portlet-body form" id="main-content">
        <form role="form" action="<?php echo site_url("$pathController/edit/".($model->id?$model->id:'')."?type={$type}");?>" id="form-edit" method="post" enctype="multipart/form-data">
        <div class="form-body">
            <input type="hidden" name="callback" value="<?php echo $callback;?>">

            <div class="form-group">
					<label for="input_title">Title</label>
					<input type="text" class="form-control" id="input_title" name="Term[title]" value="<?php echo $model->title;?>" placeholder="Enter Title...">
					<div class="help-block"></div>
				</div>

				<div class="form-group">
					<label for="input_description">Description</label>
					<textarea class="form-control" id="input_description" name="Term[description]" placeholder="Enter Description..."><?php echo $model->description;?></textarea>
					<div class="help-block"></div>
				</div>

				<div class="form-group">
					<label for="input_slug">Slug</label>
					<input type="text" class="form-control" id="input_slug" name="Term[slug]" value="<?php echo $model->slug;?>" placeholder="Enter Slug...">
					<div class="help-block"></div>
				</div>
