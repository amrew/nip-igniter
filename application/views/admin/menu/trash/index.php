	...
	<div class="col-md-12">
		...
		<div class="portlet light">
			...
			<div class="portlet-body">
				...
				<th>
					<a href="#" class="sorting" data-field="controller" data-direction="asc">
						Controller <span class="glyphicon glyphicon-sort hidden-print"></span>
					</a>
				</th>
				<th>
					<a href="#" class="sorting" data-field="params" data-direction="asc">
						Params <span class="glyphicon glyphicon-sort hidden-print"></span>
					</a>
				</th>
				...
				<td>
					<input type="text" name="controller" class="form-control input-search " placeholder="Search by Controller..." value="<?php echo isset($_GET["keywords"]["controller"])?$_GET["keywords"]["controller"]:"";?>">
				</td>
				<td>
					<input type="text" name="params" class="form-control input-search " placeholder="Search by Params..." value="<?php echo isset($_GET["keywords"]["params"])?$_GET["keywords"]["params"]:"";?>">
				</td>
