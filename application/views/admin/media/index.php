								...
								<?php foreach($rows as $i => $row):?>
									<tr id="tr-<?php echo $row->id;?>">
										...
										<td>
											...
											<?php if(!empty($row->url) && @is_array(getimagesize($row->url))):?>
									            <a href="<?php echo $row->path;?>" target="_blank">
										            <img src="<?php echo $row->path;?>" width="100" class="img-thumbnail">
									        	</a>
									        <?php elseif(!empty($row->url)):?>
									            <a href="<?php echo $row->path;?>" target="_blank"><?php echo basename($row->path);?></a>
									        <?php endif;?>
										</td>
