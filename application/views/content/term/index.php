	...
	<div class="row">
        ...
        <div class="col-md-12">
        	<div class="box box-success">
				...
				<th>
					<a href="#" class="sorting" data-field="description" data-direction="asc">
						Description <span class="glyphicon glyphicon-sort hidden-print"></span>
					</a>
				</th>
				...
				<td>
					<input type="text" name="description" class="form-control input-search " placeholder="Search by Description..." value="<?php echo isset($_GET["keywords"]["description"])?$_GET["keywords"]["description"]:"";?>">
				</td>
