...
.feature .one-col blockquote:after {
  content: '';
  display: block;
  background: -moz-linear-gradient(left, #f7f7f7 25%, #d9d9d9 25%, #d9d9d9 75%, #f7f7f7 75%);
  background: -webkit-gradient(linear, left top, right top, color-stop(25%, #f7f7f7), color-stop(25%, #d9d9d9), color-stop(75%, #d9d9d9), color-stop(75%, #f7f7f7));
  background: -webkit-linear-gradient(left, #f7f7f7 25%, #d9d9d9 25%, #d9d9d9 75%, #f7f7f7 75%);
  background: -o-linear-gradient(left, #f7f7f7 25%, #d9d9d9 25%, #d9d9d9 75%, #f7f7f7 75%);
  background: -ms-linear-gradient(left, #f7f7f7 25%, #d9d9d9 25%, #d9d9d9 75%, #f7f7f7 75%);
  background: linear-gradient(to right, #f7f7f7 25%, #d9d9d9 25%, #d9d9d9 75%, #f7f7f7 75%);
  position: absolute;
  height: 2px;
  width: 100%;
}
...
<meta property="og:title" content="My First Campaign" />
  ...
  <body class="emb-font-stack-default" style="margin-top: 0;margin-bottom: 0;margin-left: 0;margin-right: 0;padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;min-width: 100%" bgcolor="#fbfbfb">
    <center class="wrapper" style="background-color: #fbfbfb;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%">
      <table class="wrapper" style="border-collapse: collapse;border-spacing: 0;background-color: #fbfbfb;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;table-layout: fixed">
        <tbody><tr>
          <td style="padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;vertical-align: top">
            <center>
              ...
              <table class="header" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
                <tbody><tr class="border" style="font-size: 1px;line-height: 1px;background-color: #e9e9e9;height: 1px"><td style="padding-top: 0;padding-bottom: 0;padding-left: 0;padding-right: 0;vertical-align: top;line-height: 1px;width: 602px">&nbsp;</td></tr>
                <tr><td class="logo" style="padding-top: 32px;padding-bottom: 32px;padding-left: 0;padding-right: 0;vertical-align: top;font-family: sans-serif;color: #41637e;font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;text-align: center" align="center"><center><div id="emb-email-header"><a style="color: #41637e;text-decoration: none;transition: color .2s" href="http://nipstudio.com"><img style="border-left-width: 0;border-top-width: 0;border-bottom-width: 0;border-right-width: 0;-ms-interpolation-mode: bicubic;display: block;margin-top: 0;margin-bottom: 0;margin-left: auto;margin-right: auto;max-width: 335px" src="<?php echo base_url();?>public/img/nip-igniter-logo.png" alt="NipStudio Logo" width="253" height="79" /></a></div></center></td></tr>
              </tbody></table>
            </center>
          </td>
        </tr>
          ...
          <table class="wrapper" style="border-collapse: collapse;border-spacing: 0;background-color: #fbfbfb;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;table-layout: fixed">
            ...
            <h1 style="Margin-top: 0;font-weight: 700;letter-spacing: -0.03em;-webkit-font-smoothing: antialiased;color: #565656;font-size: 36px;line-height: 42px;Margin-bottom: 18px;font-family: sans-serif"><?php echo $title;?></h1><p style="Margin-top: 0;-moz-osx-font-smoothing: grayscale;font-family: Georgia, serif;color: #565656;Margin-bottom: 24px;-webkit-font-smoothing: antialiased;font-size: 16px;line-height: 24px"><?php echo $content;?></p>
