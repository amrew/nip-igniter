<?php $assets_url = base_url().'public/theme/admin-lte2/';?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
    ...
    <link href="<?php echo $assets_url;?>dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />

    <!-- iCheck for checkboxes and radio inputs -->
    <link href="<?php echo $assets_url;?>plugins/iCheck/all.css" rel="stylesheet" type="text/css" />
    <!-- Sweetalert CSS -->
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="<?php echo $assets_url;?>index2.html" class="logo"><b>Admin</b>LTE</a>
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $assets_url;?>dist/img/user3-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo $assets_url;?>dist/img/user4-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Developers
    ...
    <script src="<?php echo $assets_url;?>dist/js/demo.js" type="text/javascript"></script>
