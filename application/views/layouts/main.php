...
<html>
    ...
    <body class="skin-blue">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo base_url();?>public/theme/admin-lte/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo base_url();?>public/theme/admin-lte/img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
        ...
        <script src="<?php echo base_url();?>public/theme/admin-lte/js/AdminLTE/demo.js" type="text/javascript"></script>
